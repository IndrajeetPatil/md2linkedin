...
- **Tables**: rows rendered as labelled values, so columns remain readable in plain text
...
- **Tables**: Rows are rendered as labelled values rather than aligned columns, since LinkedIn uses proportional fonts.
